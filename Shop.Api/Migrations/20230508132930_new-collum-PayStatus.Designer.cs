...
namespace Shop.Api.Migrations
{
    ...
    [Migration("20230508132930_new-collum-PayStatus")]
    partial class newcollumPayStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Api.Data.UserApp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shop.Api.Data.UserApp", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shop.Api.Data.BillDetail", b =>
                {
                    b.HasOne("Shop.Api.Data.Bill", "Bill")
            ...
            modelBuilder.Entity("Shop.Api.Data.Size", b =>
                {
                    b.HasOne("Shop.Api.Data.Product", "Products")
                        .WithMany("Sizes")
